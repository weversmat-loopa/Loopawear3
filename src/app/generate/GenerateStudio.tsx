...
// Loaded client-side only — Fabric.js requires browser APIs.
    ...
    <main className="flex flex-1 flex-col px-6 py-14 md:py-18">
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[1fr_340px] lg:gap-10">
          ...
          {/* Controls panel */}
          <div className="rounded-xl border border-zinc-200 bg-white p-6 lg:p-7 dark:border-zinc-700 dark:bg-zinc-900">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <textarea
                  ...
                  className="mt-2.5 w-full resize-none rounded-lg border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 placeholder:text-zinc-400 outline-none transition-colors focus:border-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:placeholder:text-zinc-500 dark:focus:border-zinc-400"
                />
                {!userHasTypedPrompt && (
                  <div className="mt-3">
                    ...
                    <button
                      ...
                      className={`rounded-full border px-3.5 py-1.5 text-xs font-medium transition-colors ${
                        styleMood === style
                          ...
                          : "border-zinc-200 text-zinc-500 hover:border-zinc-400 hover:text-zinc-900 dark:border-zinc-700 dark:text-zinc-400 dark:hover:border-zinc-500 dark:hover:text-zinc-100"
                      }`}
                    >
                      {style}
                    </button>
              ...
              {saveState.status === "auth_required" && (
                <p className="text-sm text-zinc-500">
                  <Link
                    href="/login"
                    className="text-zinc-900 underline underline-offset-2 transition-colors hover:text-zinc-600 dark:text-zinc-100"
                  >
                    Sign in
                  </Link>{" "}
        ...
        {/* Placement editor — shown after a design is successfully generated. */}
        {saveState.status === "generated" && (
          <PlacementEditor
